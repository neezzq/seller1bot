...
async def cmd_start(event: types.Message | types.CallbackQuery, state: FSMContext):
    ...
    text = (
        f"{me('hello', '👋')} <b>Добро пожаловать в Seller TON!</b>\n\n"
    "Здесь вы можете быстро и удобно купить <b>TON</b> за <b>UAH</b> или <b>RUB</b>.\n"
    "Мы сделали процесс максимально простым: выберите валюту, укажите количество TON, "
    "получите реквизиты для оплаты и отправьте чек после перевода.\n\n"
